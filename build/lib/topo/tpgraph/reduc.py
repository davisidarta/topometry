...
import numpy as np
from topo.tpgraph.GL import GLGraph, InvLaplGraph
from igraph import *
...
def Coarse(edges,
    ...
    while not connected:  # In case the graph becomes disconnected, try again.
        ...
        reducedLaplacianOriginalDimension = g.project_reduced_to_original(g.nodeWeightedInverseLaplacian)
        return reducedLaplacianOriginalDimension
