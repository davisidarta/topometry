...
<head>
  ...
  <title>Ways to Contribute &mdash; TopOMetry  documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../_sources/env/lib64/python3.8/site-packages/scipy/HACKING.rst.txt" rel="nofollow"> View page source</a>
...
<span id="hacking"></span><h1>Ways to Contribute<a class="headerlink" href="#ways-to-contribute" title="Permalink to this headline">¶</a></h1>
<p>This document aims to give an overview of the ways to contribute to SciPy.  It
...
<span class="xref std std-ref">contributor-toc</span>.</p>
<p>There are a lot of ways you can contribute:</p>
<ul class="simple">
<li><p>Contributing new code</p></li>
<li><p>Fixing bugs, improving documentation, and other maintenance work</p></li>
...
SciPy subpackages (see <span class="xref std std-ref">deciding-on-new-features</span>).  In principle new
...
use the code.  Some SciKits (<a class="reference external" href="http://scikit-learn.org">scikit-learn</a>, <a class="reference external" href="http://scikit-image.org/">scikit-image</a>, <a class="reference external" href="https://www.statsmodels.org/">statsmodels</a>,
etc.) are good examples here; they have a narrower focus and because of that
more domain-specific code than SciPy.</p>
...
compatible license (see <a class="reference internal" href="#license-considerations"><span class="std std-ref">License Considerations</span></a>), the first step is to
...
tests, benchmarks, and correct code style.</p>
...
tests is given in <span class="xref std std-doc">numpy:reference/testing</span>, and <span class="xref std std-ref">runtests</span>
documents how to run them.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt>Benchmarks</dt><dd><p>Unit tests check for correct functionality; benchmarks measure code
...
and running benchmarks is available in <span class="xref std std-ref">benchmarking-with-asv</span>.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
...
write documentation is given in <span class="xref std std-ref">numpy:howto-document</span>, and
<span class="xref std std-ref">rendering-documentation</span> explains how to preview the documentation
as it will appear online.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
...
idea. More information is available in <span class="xref std std-ref">pep8-scipy</span>.</p>
</dd>
</dl>
</li>
</ol>
<p>A <span class="xref std std-ref">checklist</span>, including these and other requirements, is
available at the end of the example <span class="xref std std-ref">development-workflow</span>.</p>
...
<code class="docutils literal notranslate"><span class="pre">scipy.subpackage.my_new_func</span></code>.  <code class="docutils literal notranslate"><span class="pre">my_new_func</span></code> can be put in an existing or
new file under <code class="docutils literal notranslate"><span class="pre">/scipy/&lt;subpackage&gt;/</span></code>, its name is added to the <code class="docutils literal notranslate"><span class="pre">__all__</span></code>
list in that file (which lists all public functions in the file), and those
public functions are then imported in  <code class="docutils literal notranslate"><span class="pre">/scipy/&lt;subpackage&gt;/__init__.py</span></code>.  Any
...
in <span class="xref std std-ref">scipy-api</span>.</p>
...
here, this is described well in <span class="xref std std-ref">git-development</span>
and on the <a class="reference external" href="https://help.github.com/articles/set-up-git/">Github help pages</a>.  When you send the PR for a new
...
<div class="section" id="license-considerations">
<span id="id1"></span><h3>License Considerations<a class="headerlink" href="#license-considerations" title="Permalink to this headline">¶</a></h3>
...
If you’re unsure, please ask on the scipy-dev <a class="reference external" href="mailinglists">mailing list</a>.</p>
...
<p>For more information about SciPy’s license, see <span class="xref std std-ref">scipy-licensing</span>.</p>
</div>
</div>
<div class="section" id="maintaining-existing-code">
<h2>Maintaining existing code<a class="headerlink" href="#maintaining-existing-code" title="Permalink to this headline">¶</a></h2>
...
benchmarks, keeping build scripts up-to-date, etc.  The SciPy <a class="reference external" href="https://github.com/scipy/scipy/issues">issue list</a>
...
<p>There are many ways to contribute other than writing code.</p>
...
issues easily when working on an existing function or subpackage.</p>
...
<p>Thanks for your interest in contributing to SciPy! If you’re interested in
contributing code, we hope you’ll continue on to the <span class="xref std std-ref">contributor-toc</span>
for details on how to set up your development environment, implement your
improvements, and submit your first PR!</p>
</div>
</div>
